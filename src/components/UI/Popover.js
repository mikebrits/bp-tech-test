...
export const Popover = ({
    ...
    // const handleClick = useCallback(() => handleClick, [handleClick]);
    ...
    const updatePortalPosition = useCallback(
        ...
        [align, alignOffset, position, positionOffset, top, anchor, left],
    );
    ...
    useEffect(
        ...
        [open, handleClick, updatePortalPosition],
    );
